# Rahul Wani — Developer & Designer Portfolio

A dark-themed personal portfolio for **Rahul Wani** — Computer Science graduate from NSUT, currently a Content R&D Trainee at PhysicsWallah. Focused on UI/UX, front-end development, and GenAI integration.
...
|---|---|---|
| ResumeIQ | [resumeiq-rahul.vercel.app](https://resumeiq-rahul.vercel.app) | React, Gemini API, Vercel |
...
Designed & built by **Rahul Wani** · [LinkedIn](https://www.linkedin.com/in/rahul-wani/) · [GitHub](https://github.com/rahulwani)
