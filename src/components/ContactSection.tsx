...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'rahulwani737@gmail.com',
    href: 'mailto:rahulwani737@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 84594 22159',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/918459422159',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/rahul-wani',
    href: 'https://www.linkedin.com/in/rahul-wani/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@rahulwani',
    href: 'https://github.com/rahulwani',
  },
];
